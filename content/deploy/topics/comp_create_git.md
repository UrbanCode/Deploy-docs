# Creating components from Git {#comp_create_git .task}

Git is a source-code management system.

Install Git on the IBM® UrbanCode® Deploy server. When you create the component, you must specify the path to the Git executable file.
