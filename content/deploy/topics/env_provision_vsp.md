# Provisioning environments through the server \(through virtual system patterns\) {#env_provision_vsp .task}

You can provision environments on a cloud system as part of creating an application environment on the IBM® UrbanCode® Deploy server.
...
-   Connect to a cloud system and create blueprints for that cloud. See [Connecting to clouds through IBM UrbanCode Deploy](cloud_integrate_vsp_ov.md).
