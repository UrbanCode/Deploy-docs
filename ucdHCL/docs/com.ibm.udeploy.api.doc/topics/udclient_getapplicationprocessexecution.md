...
udclient -username jsmith -password passwd 
  ...
  getApplicationProcessExecution
  -request 151cd268-ef32-4e55-903b-86ee66314e1e
```
...
Related REST command: [Get an application process request's activity trace.](rest_cli_applicationprocessrequest_request_get.md).
